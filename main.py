...
def printlogo():
    ...
    pc.printout("\nVersion 1.0 - Developed by Senior Farbod\n\n", pc.YELLOW)
...
parser = argparse.ArgumentParser(description='Osintgram is a OSINT tool on Instagram.an interactive shell '
                                             'to perform analysis on Instagram account of any users')
